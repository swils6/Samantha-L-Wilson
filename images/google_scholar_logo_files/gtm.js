...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_uniqueTriggerId":"9674961_130",
      ...
      "vtp_uniqueTriggerId":"9674961_228",
      "tag_id":232
    },{
      "function":"__html",
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cdiv class=\"cookies-widget-wrapper\"\u003E\n  \u003Cdiv class=\"cookies-widget\"\u003E\n     \u003Cdiv class=\"cookies-content\" id=\"cookies-content\"\u003E\n        \u003Cp\u003EWe track sessions with cookies\u003C\/p\u003E\n        \u003Cp class=\"cookies-expand\" id=\"btn-expand\"\u003EFor what?\u003C\/p\u003E\n     \u003C\/div\u003E\n     \u003Cdiv class=\"cookies-content-expanded is-hide\" id=\"cookies-content-expanded\"\u003E\n        \u003Cp\u003E\n           We use cookies and local storage for better UX (such as your collections in icons app), extra powers for the paid users, analytics, and ads.\n        \u003C\/p\u003E\n        \u003Cdiv\u003E\n           \u003Ca target=\"_blank\" href=\"https:\/\/icons8.com\/privacy-policy\" class=\"cookies-privacy\"\u003EOur privacy policy\u003C\/a\u003E\n        \u003C\/div\u003E\n     \u003C\/div\u003E\n     \u003Cbutton class=\"close\" id=\"btn-close\"\u003EOK\u003C\/button\u003E\n  \u003C\/div\u003E\n\u003C\/div\u003E\n\n\u003Cstyle\u003E\n  .cookies-widget-wrapper {\n     z-index: 9999;\n     position: fixed;\n     bottom: 20px;\n     left: 0;\n     right: 0;\n     margin: 0 auto;\n     display: none;\n     justify-content: center;\n     align-items: center;\n     box-sizing: border-box;\n     -webkit-transition-duration: .4s;\n     transition-duration: .4s;\n     -webkit-animation-duration: .4s;\n     animation-duration: .4s;\n     -webkit-animation-fill-mode: forwards;\n     animation-fill-mode: forwards;\n  }\n  .cookies-widget {\n     display: flex;\n     flex-direction: column;\n     background: rgba(33, 41, 50, 0.8);\n     border-radius: 6px;\n     font-family: -apple-system, BlinkMacSystemFont, 'San Francisco', 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', 'Segoe UI', 'Fira Sans', Roboto, Oxygen, Ubuntu, 'Droid Sans', 'Arial', sans-serif;\n     font-weight: 600;\n     font-size: 14px;\n     line-height: 20px;\n     color: #FFF;\n     padding: 14px 70px 14px 24px;\n     position: relative;\n     box-sizing: border-box;\n  }\n  \n  .cookies-widget-wrapper.is-active {\n     -webkit-animation-name: zoomIn;\n     animation-name: zoomIn;\n  }\n  .cookies-widget-wrapper.is-hide {\n     -webkit-animation-name: zoomOut;\n     animation-name: zoomOut;\n  }\n  \n  .cookies-content {\n     display: flex;\n     align-items: center;\n  }\n  \n  .cookies-expand {\n     margin-left: 8px;\n     color: rgba(255, 255, 255, .5);\n     border-bottom: 1px dashed;\n  }\n  \n  .cookies-content p {\n     margin-top: 0;\n     margin-bottom: 0;\n     white-space: nowrap;\n  }\n  \n  @media (max-width: 375px) {\n     .cookies-widget-wrapper {\n        max-width: 304px;\n     }\n  \n     .cookies-content {\n        flex-direction: column;\n        align-items: flex-start;\n     }\n  \n     .cookies-expand {\n        margin-left: 0;\n     }\n  }\n  \n  .close {\n    border: 0;\n    outline: 0;\n    position: absolute;\n    top: 10px;\n    height: 30px;\n    width: 40px;\n    padding: 0;\n    right: 16px;\n    font-size: 14px;\n    font-weight: 600;\n    color: rgba(255, 255, 255, .5);\n    background-color: rgba(255,255,255, .1);\n    border-radius: 4px;\n  }\n  .close:focus {\n    box-shadow: 0 0 0 1px rgba(255,255,255, .5);\n  }\n  \n  .cookies-expand:hover, .close:hover {\n     color: rgba(255, 255, 255);\n     cursor: pointer;\n  }\n  \n  a[class=\"cookies-privacy\"] {\n     color: rgba(255, 255, 255, .5);\n     text-decoration: none;\n     border-bottom: 1px solid rgba(255, 255, 255, .2);\n  }\n  \n  a[class=\"cookies-privacy\"]:hover {\n     color: rgba(255, 255, 255);\n     border-bottom-color: rgba(255, 255, 255);\n  }\n  \n  .cookies-content-expanded {\n     max-width: 363px;\n  }\n  \n  .cookies-content-expanded p {\n     margin-top: 0;\n     margin-bottom: 8px;\n  }\n  \n  .is-hide {\n     display: none;\n  }\n  \n  @-webkit-keyframes zoomIn {\n    from {\n      opacity: 0;\n      -webkit-transform: scale3d(0.3, 0.3, 0.3);\n      transform: scale3d(0.3, 0.3, 0.3);\n    }\n  \n    50% {\n      opacity: 1;\n    }\n  }\n  \n  @keyframes zoomIn {\n    from {\n      opacity: 0;\n      -webkit-transform: scale3d(0.3, 0.3, 0.3);\n      transform: scale3d(0.3, 0.3, 0.3);\n    }\n  \n    50% {\n      opacity: 1;\n    }\n  }\n  \n  @-webkit-keyframes zoomOut {\n    from {\n      opacity: 1;\n    }\n  \n    50% {\n      opacity: 0;\n      -webkit-transform: scale3d(0.3, 0.3, 0.3);\n      transform: scale3d(0.3, 0.3, 0.3);\n    }\n  \n    to {\n      opacity: 0;\n    }\n  }\n  \n  @keyframes zoomOut {\n    from {\n      opacity: 1;\n    }\n  \n    50% {\n      opacity: 0;\n      -webkit-transform: scale3d(0.3, 0.3, 0.3);\n      transform: scale3d(0.3, 0.3, 0.3);\n    }\n  \n    to {\n      opacity: 0;\n    }\n  }\n  \u003C\/style\u003E\n  \n  \u003Cscript type=\"text\/gtmscript\"\u003Evar btnExpand=document.getElementById(\"btn-expand\"),cookiesContent=document.getElementById(\"cookies-content\"),cookiesContentExpand=document.getElementById(\"cookies-content-expanded\"),_timeZone=(new Date).getTimezoneOffset()\/60*-1;btnExpand.onclick=function(){cookiesContentExpand.classList.remove(\"is-hide\");cookiesContent.classList.add(\"is-hide\")};\nfunction CustomEventTrigger(b,d,a){a={detail:a,bubbles:!0,cancelable:!0};if(\"CustomEvent\"in window\u0026\u0026\"function\"===typeof window.CustomEvent)var c=new CustomEvent(b,a);else c=document.createEvent(\"CustomEvent\"),c.initCustomEvent(b,!0,!0,a);d.dispatchEvent(c)}\nvar cookiesWidget={id:\"cookies-europe\",container:document.querySelector(\".cookies-widget-wrapper\"),isEurope:3===_timeZone\u0026\u0026\"ru-RU\"!==navigator.language||0\u003C=_timeZone\u0026\u00262\u003E=_timeZone,show:function(){setTimeout(function(){cookiesWidget.container.style.display=\"flex\";cookiesWidget.container.classList.add(\"is-active\");document.body.classList.add(\"cookies-widget-active\")},300)},saveToStorage:function(){localStorage.setItem(\"cookiesWidget\",cookiesWidget.id)},hide:function(b){cookiesWidget.container.classList.remove(\"is-active\");\ncookiesWidget.container.classList.add(\"is-hide\");setTimeout(function(){cookiesWidget.container.style.display=\"none\";document.body.classList.remove(\"cookies-widget-active\")},400)},isEnabled:function(){return localStorage.getItem(\"cookiesWidget\")!==cookiesWidget.id\u0026\u0026cookiesWidget.isEurope}};cookiesWidget.isEnabled()\u0026\u0026cookiesWidget.show();var btnClose=document.getElementById(\"btn-close\");\nbtnClose.onclick=function(){cookiesWidget.saveToStorage();cookiesWidget.hide();CustomEventTrigger(\"gdpr\",document,{apply:!0})};\u003C\/script\u003E",
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Eif(0\u003C=location.search.indexOf(\"crowdin-overlay\")){var _jipt=[];_jipt.push([\"project\",\"icons8\"]);(function(a){var b=a.createElement(\"script\");b.setAttribute(\"src\",\"\/\/cdn.crowdin.com\/jipt\/jipt.js\");a.body.appendChild(b)})(document)};\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":10
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cdiv class=\"cookies-widget\"\u003E\n  \u003Cdiv class=\"cookies-content\"\u003E\n    We use cookies and local storage for better UX, analytics and suggestions. \u003Ca href=\"\/terms-and-conditions\"\u003ETerms \u0026amp; Conditions\u003C\/a\u003E\n  \u003C\/div\u003E\n  \u003Cdiv class=\"cookies-links\"\u003E\n    \u003Ca href=\"#\" class=\"cookies-agree\"\u003EAgree\u003C\/a\u003E\n    \u003Ca href=\"#\" class=\"cookies-refuse\"\u003ERefuse\u003C\/a\u003E\n  \u003C\/div\u003E\n\u003C\/div\u003E\n\n\u003Cstyle\u003E\n\/* ------------- cookies-widget-------------  *\/\n  \n.cookies-widget {\n  \t  z-index: 11;\n      background: #333333;\n      display: none;\n      opacity: 0;\n      margin: 0 auto;\n      padding: 20px 20px 18px 20px;\n      border-radius: 4px;\n      font-family: -apple-system,BlinkMacSystemFont,'San Francisco','HelveticaNeue-Light','Helvetica Neue Light','Helvetica Neue','Segoe UI','Fira Sans',Roboto,Oxygen,Ubuntu,Droid Sans,Arial,sans-serif;\n      font-size: 12px;\n      font-weight: 400;\n      line-height: 1.5;\n      max-width: 360px;\n      position: fixed;\n      bottom: 20px;\n      left: 0;\n      right: 0;\n      -webkit-transition-duration: 0.3s;\n      transition-duration: 0.3s;\n      -webkit-animation-duration: 0.3s;\n      animation-duration: 0.3s;\n      -webkit-animation-fill-mode: forwards;\n      animation-fill-mode: forwards;\n    }\n    .cookies-widget.is-active {\n      -webkit-animation-name: anim-open;\n      animation-name: anim-open;\n    }\n    .cookies-widget.is-hide {\n      -webkit-animation-name: anim-close;\n      animation-name: anim-close;\n    }\n\n    .cookies-content {\n      margin: 0;\n      margin-bottom: 10px;\n      font-size: 13px;\n      line-height: 23px;\n      color: #fff;\n    }\n    \n    .cookies-content a {\n      margin-top: 2px;\n      color: rgba(255, 255, 255, 0.5);\n      text-decoration: none;\n      border-bottom: 1px solid rgba(255, 255, 255, 0.15);\n    }\n\n    .cookies-content a:visited {\n      color: rgba(255, 255, 255, 0.5);\n    }\n\n    .cookies-expand:hover .cookies-label {\n      color: #444;\n    }\n\n    .cookies-expand:hover .cookies-arrow {\n      fill: #444;\n    }\n\n    .cookies-label {\n      margin: 0;\n      text-transform: uppercase;\n      color: #000;\n      transition: 0.2s;\n    }\n\n    .cookies-arrow {\n      position: relative;\n      margin-left: 2px;\n      top: 0;\n      fill: #000;\n      transform: rotate(180deg);\n      transition: fill 0.2s;\n      width: 10px;\n      height: 10px;\n      display: inline-block;\n      background: url(\"data:image\/svg+xml;base64,\") no-repeat;\n    }\n\n    .cookies-privacy {\n      color: #000;\n      transition: 0.2s;\n    }\n\n    .cookies-privacy:hover {\n      color: #444;\n    }\n\n    .cookies-links {\n      display: flex;\n    }\n\n    .cookies-agree {\n      text-decoration: none;\n      color: #5162FF;\n      font-weight: 700;\n      font-size: 13px;\n      line-height: 18px;\n      border-bottom: 1px solid rgba(81, 98, 255, 0.25);\n      margin-right: 15px;\n    }\n\n    .cookies-refuse {\n      text-decoration: none;\n      font-weight: 700;\n      font-size: 13px;\n      line-height: 18px;\n      color: rgba(255, 255, 255, 0.5);\n      border-bottom: 1px solid rgba(255, 255, 255, 0.1);\n    }\n\n    @-webkit-keyframes anim-open {\n      0% {\n        opacity: 0;\n        -webkit-transform: translate3d(0, 50px, 0);\n      }\n\n      100% {\n        opacity: 1;\n        -webkit-transform: translate3d(0, 0, 0);\n      }\n    }\n\n    @keyframes anim-open {\n      0% {\n        opacity: 0;\n        -webkit-transform: translate3d(0, 50px, 0);\n        transform: translate3d(0, 50px, 0);\n      }\n\n      100% {\n        opacity: 1;\n        -webkit-transform: translate3d(0, 0, 0);\n        transform: translate3d(0, 0, 0);\n      }\n    }\n\u003C\/style\u003E\n\n\u003Cscript type=\"text\/gtmscript\"\u003Evar ip;function getIP(a){ip=a.ip}\nvar expandButton=document.getElementById(\"cookies-expand\"),cookiesArrow=document.getElementById(\"cookies-arrow\"),cookiesText=document.getElementById(\"cookies-text\"),cookiesWidget={id:\"cookies-europe\",container:document.querySelector(\".cookies-widget\"),agreeBtn:document.querySelector(\".cookies-agree\"),refuseBtn:document.querySelector(\".cookies-refuse\"),show:function(){cookiesWidget.container.style.display=\"block\";setTimeout(function(){cookiesWidget.container.classList.add(\"is-active\")},300)},saveToStorage:function(){localStorage.setItem(\"cookiesWidget\",\ncookiesWidget.id)},hide:function(a){cookiesWidget.container.classList.remove(\"is-active\");cookiesWidget.container.classList.add(\"is-hide\");setTimeout(function(){cookiesWidget.container.style.display=\"none\"},400);\"cookies-agree\"===a.target.className\u0026\u0026cookiesWidget.saveToStorage();\"cookies-refuse\"===a.target.className\u0026\u0026(location.href.includes(\"generated.photos\")?location.href=\"https:\/\/google.com\/\":location.href=\"https:\/\/img.icons8.com\/\")},isEnabled:function(){return localStorage.getItem(\"cookiesWidget\")!==\ncookiesWidget.id}};cookiesWidget.isEnabled()\u0026\u0026(cookiesWidget.agreeBtn.addEventListener(\"click\",cookiesWidget.hide),cookiesWidget.refuseBtn.addEventListener(\"click\",cookiesWidget.hide),cookiesWidget.show());\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\" data-gtmsrc=\"https:\/\/api.ipify.org?format=jsonp\u0026amp;callback=getIP\"\u003E\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":36
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",0],
      "arg1":"generated.photos\/face-generator"
    },{
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"\/ouch"
      ...
      "function":"_sw",
      "arg0":["macro",0],
      "arg1":"https:\/\/icons8.com\/animated-icons"
    },{
      "function":"_cn",
      "arg0":["macro",0],
      "arg1":"vector-creator"
      ...
      "function":"_cn",
      "arg0":["macro",0],
      "arg1":"generated.photos\/use-cases"
    },{
      "function":"_cn",
      "arg0":["macro",0],
      "arg1":"producthunt.com\/posts\/face-generator"
    },{
      "function":"_eq",
      "arg0":["macro",1],
      "arg1":"gtm.linkClick"
      ...
      "function":"_cn",
      "arg0":["macro",0],
      "arg1":"\/creator\/template"
    },{
      "function":"_cn",
      "arg0":["macro",0],
      "arg1":"\/creator\/dashboard"
    }],
  "rules":[
    [["if",1],["unless",0],["add",0,2,10]],
    [["if",1],["unless",2],["add",1,31,32,36,47]],
    [["if",1],["unless",3,4],["add",3]],
    [["if",1],["unless",4,5],["add",4]],
    [["if",1],["unless",0,6,7],["add",5]],
    [["if",1],["add",6,29,57,66,9,63,64]],
    [["if",1,8],["add",7]],
    [["if",1,9],["add",8,24,45]],
    [["if",1],["unless",6,7,9],["add",11]],
    [["if",1,10],["unless",2],["add",12,25,60]],
    [["if",1],["unless",6,11],["add",13]],
    [["if",1],["unless",7,12,13],["add",14]],
    [["if",1,14],["add",15]],
    [["if",1],["unless",15,16],["add",16]],
    [["if",1,15],["add",17]],
    [["if",1],["unless",11,17,18],["add",18]],
    [["if",1,17],["add",19]],
    [["if",1,10],["unless",6],["add",20,22,26,67]],
    [["if",1],["unless",6,10],["add",21,27,30,33,37,38,39,40,41,43,44,46,48,49,50,51,53,54,55,56,58,59]],
    [["if",1],["unless",6,9,10],["add",23]],
    [["if",1,19],["add",28]],
    [["if",1,20],["add",34]],
    [["if",1,10,21],["add",35]],
    [["if",1],["unless",9,10],["add",42]],
    [["if",1,22],["add",52]],
    [["if",23,24,25],["add",61]],
    [["if",26],["add",62]],
    [["if",1],["unless",10,27,28,29,30],["add",65]]]
},
"runtime":[]
...
var Od=[m.C,m.F],Pd=function(a){var b=a[m.te];b&&yc(40);var c=a[m.ue];c&&yc(41);for(var d=xa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==m.te&&f!==m.ue)if(-1<ya(Od,f)){var h=f,k=a[f],l=d[e];zd().set(h,k,l,"CA","CA-ON",c)}else{var n=f,q=a[f],p=d[e];zd().set(n,q,p,"CA","CA-ON",c);}},Qd=function(a,
...
null))}return!1};
var $d=function(){var a=D.body,b=D.documentElement||a&&a.parentElement,c,d;if(D.compatMode&&"BackCompat"!==D.compatMode)c=b?b.clientHeight:0,d=b?b.clientWidth:0;else{var e=function(f,h){return f&&h?Math.min(f,h):Math.max(f,h)};yc(7);c=e(b?b.clientHeight:0,a?a.clientHeight:0);d=e(b?b.clientWidth:0,a?a.clientWidth:0)}return{width:d,height:c}},ae=function(a){var b=$d(),c=b.height,d=b.width,e=a.getBoundingClientRect(),f=e.bottom-e.top,h=e.right-e.left;return f&&h?(1-Math.min((Math.max(0-e.left,0)+Math.max(e.right-
d,0))/h,1))*(1-Math.min((Math.max(0-e.top,0)+Math.max(e.bottom-c,0))/f,1)):0};var he=/:[0-9]+$/,ie=function(a,b,c){for(var d=a.split("&"),e=0;e<d.length;e++){var f=d[e].split("=");if(decodeURIComponent(f[0]).replace(/\+/g," ")===b){var h=f.slice(1).join("=");return c?h:decodeURIComponent(h).replace(/\+/g," ")}}},le=function(a,b,c,d,e){b&&(b=String(b).toLowerCase());if("protocol"===b||"port"===b)a.protocol=je(a.protocol)||je(B.location.protocol);"port"===b?a.port=String(Number(a.hostname?a.port:B.location.port)||("http"==a.protocol?80:"https"==a.protocol?443:"")):"host"===b&&
...
u[0],x;if(B.location){var z=ke(B.location,"host",!0);x=0<=v.toLowerCase().indexOf(z)}else x=!1;x||q.push({element:r,ra:v})}}}var w=ye(q),y=[];if(w){var A=w.element,C={ra:w.ra,tagName:A.tagName,type:1};C.querySelector=we(A);C.isVisible=!Zd(A);y.push(C)}return{elements:y,status:10<q.length?"3":l.status}},Ae=function(a){return a.tagName+":"+a.isVisible+":"+a.ra.length+":"+qe.test(a.ra)};var Te={},Ue=null,Ve=Math.random();Te.M="GTM-5W9QXH7";Te.Gc="621";Te.gi="";Te.cg="ChAI8J7nhQYQ2L2D9+6FqplVEiQAmpUlvRRNTAK3gjj9oGrYIDfS1ArZ4BiiTnQ696y0j5MPQGcaArL3";var We={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Xe={__paused:!0,__tg:!0},Ye;for(Ye in We)We.hasOwnProperty(Ye)&&(Xe[Ye]=!0);var Ze="www.googletagmanager.com/gtm.js";
var $e=Ze,af=Ma(""),bf=null,cf=null,df="https://www.googletagmanager.com/a?id="+Te.M+"&cv=248",ef={},ff={},gf=function(){var a=Ue.sequence||1;Ue.sequence=a+1;return a};Te.bg="";var hf={},jf=new Da,kf={},lf={},of={name:"GTMDataLayer",set:function(a,b){g(Ya(a,b),kf);mf()},get:function(a){return nf(a,2)},reset:function(){jf=new Da;kf={};mf()}},nf=function(a,b){return 2!=b?jf.get(a):pf(a)},pf=function(a){var b,c=a.split(".");b=b||[];for(var d=kf,e=0;e<c.length;e++){if(null===d)return!1;if(void 0===d)break;d=d[c[e]];if(-1!==ya(b,d))return}return d},qf=function(a,b){lf.hasOwnProperty(a)||(jf.set(a,b),g(Ya(a,b),kf),mf())},mf=function(a){Ga(lf,function(b,c){jf.set(b,c);g(Ya(b,
...
function pn(){var b=on();try{Km(B["GTMDataLayer"],Te.M)}catch(c){}return b}
var rn=function(){var a=bd("GTMDataLayer",[]),b=bd("google_tag_manager",{});b=b["GTMDataLayer"]=b["GTMDataLayer"]||{};ei(function(){b.gtmDom||(b.gtmDom=!0,a.push({event:"gtm.dom"}))});ym(function(){b.gtmLoad||(b.gtmLoad=!0,a.push({event:"gtm.load"}))});b.subscribers=(b.subscribers||0)+1;var c=a.push;a.push=function(){var e;if(0<Ue.SANDBOXED_JS_SEMAPHORE){e=[];for(var f=0;f<arguments.length;f++)e[f]=new en(arguments[f])}else e=[].slice.call(arguments,0);var h=c.apply(a,e);fn.push.apply(fn,e);if(300<
...
V.g.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(w){for(var y=[],A=w.split(","),C=0;C<A.length;C++){var F=Number(A[C]);if(isNaN(F))return[];q.test(A[C])||y.push(F)}return y}function c(){var w=0,y=0;return function(){var A=$d(),C=A.height;w=Math.max(v.scrollLeft+A.width,w);y=Math.max(v.scrollTop+C,y);return{lh:w,mh:y}}}function d(){t=L("self");
u=t.document;v=u.scrollingElement||u.body&&u.body.parentNode;z=c()}function e(w,y,A,C){var F=l(y),E={},H;for(H in F){E.kb=H;if(F.hasOwnProperty(E.kb)){var P=Number(E.kb);w<P||(Rn({event:"gtm.scrollDepth","gtm.scrollThreshold":P,"gtm.scrollUnits":A.toLowerCase(),"gtm.scrollDirection":C,"gtm.triggers":F[E.kb].join(",")}),pm("sdl",y,function(N){return function(O){delete O[N.kb];return O}}(E),{}))}E={kb:E.kb}}}function f(){var w=z(),y=w.lh,A=w.mh,C=y/v.scrollWidth*100,F=A/v.scrollHeight*100;e(y,"horiz.pix",
p.Ec,r.Ze);e(C,"horiz.pct",p.Dc,r.Ze);e(A,"vert.pix",p.Ec,r.pf);e(F,"vert.pct",p.Dc,r.pf);om("sdl","pending",!1)}function h(){var w=250,y=!1;u.scrollingElement&&u.documentElement&&t.addEventListener&&(w=50,y=!0);var A=0,C=!1,F=function(){C?A=Ln(F,w):(A=0,f(),Wn("sdl")&&!a()&&(id(t,"scroll",E),id(t,"resize",E),om("sdl","init",!1)));C=!1},E=function(){y&&z();A?C=!0:(A=Ln(F,w),om("sdl","pending",!0))};return E}function k(w,y,A){if(y){var C=b(String(w));pm("sdl",A,function(F){for(var E=0;E<C.length;E++){var H=
String(C[E]);F.hasOwnProperty(H)||(F[H]=[]);F[H].push(y)}return F},{})}}function l(w){return qm("sdl",w,{})}function n(w){G(w.vtp_gtmOnSuccess);var y=w.vtp_uniqueTriggerId,A=w.vtp_horizontalThresholdsPixels,C=w.vtp_horizontalThresholdsPercent,F=w.vtp_verticalThresholdUnits,E=w.vtp_verticalThresholdsPixels,H=w.vtp_verticalThresholdsPercent;switch(w.vtp_horizontalThresholdUnits){case p.Ec:k(A,y,"horiz.pix");break;case p.Dc:k(C,y,"horiz.pct")}switch(F){case p.Ec:k(E,y,"vert.pix");break;case p.Dc:k(H,
y,"vert.pct")}Wn("sdl")?qm("sdl","pending")||(x||(d(),x=!0),G(function(){return f()})):(d(),x=!0,v&&(Xn("sdl"),om("sdl","pending",!0),G(function(){f();if(a()){var P=h();hd(t,"scroll",P);hd(t,"resize",P)}else om("sdl","init",!1)})))}var q=/^\s*$/,p={Dc:"PERCENT",Ec:"PIXELS"},r={pf:"vertical",Ze:"horizontal"},t,u,v,x=!1,z;(function(w){V.__sdl=w;V.__sdl.h="sdl";V.__sdl.m=!0;V.__sdl.priorityOverride=0})(function(w){w.vtp_triggerStartOption?n(w):ym(function(){n(w)})})}();
...
V.g.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:Nn()}function b(f,h){hd(f,"hashchange",function(k){var l=a(k);h({source:"hashchange",state:null,url:Pn(l),X:On(l)})})}function c(f,h){hd(f,"popstate",function(k){var l=a(k);h({source:"popstate",state:k.state,url:Pn(l),X:On(l)})})}function d(f,h,k){var l=h.history,n=l[f];if(ua(n))try{l[f]=function(q,p,r){n.apply(l,[].slice.call(arguments,0));k({source:f,state:q,url:Pn(Nn()),
X:On(Nn())})}}catch(q){}}function e(){var f={source:null,state:L("history").state||null,url:Pn(Nn()),X:On(Nn())};return function(h){var k=f,l={};l[k.source]=!0;l[h.source]=!0;if(!l.popstate||!l.hashchange||k.X!=h.X){var n={event:"gtm.historyChange","gtm.historyChangeSource":h.source,"gtm.oldUrlFragment":f.X,"gtm.newUrlFragment":h.X,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":h.state,"gtm.oldUrl":f.url,"gtm.newUrl":h.url};f=h;Rn(n)}}}(function(f){V.__hl=f;V.__hl.h="hl";V.__hl.m=!0;V.__hl.priorityOverride=
0})(function(f){var h=L("self");if(!Wn("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);Xn("hl")}G(f.vtp_gtmOnSuccess)})}();
...
V.g.html=["customScripts"],function(){function a(d,e,f,h){return function(){try{if(0<e.length){var k=e.shift(),l=a(d,e,f,h);if("SCRIPT"==String(k.nodeName).toUpperCase()&&"text/gtmscript"==k.type){var n=D.createElement("script");n.async=!1;n.type="text/javascript";n.id=k.id;n.text=k.text||k.textContent||k.innerHTML||"";k.charset&&(n.charset=k.charset);var q=k.getAttribute("data-gtmsrc");q&&(n.src=q,cd(n,l));d.insertBefore(n,null);q||l()}else if(k.innerHTML&&0<=k.innerHTML.toLowerCase().indexOf("<script")){for(var p=
[];k.firstChild;)p.push(k.removeChild(k.firstChild));d.insertBefore(k,null);a(k,p,l,h)()}else d.insertBefore(k,null),l()}else f()}catch(r){G(h)}}}var c=function(d){if(D.body){var e=
d.vtp_gtmOnFailure,f=$n(d.vtp_html,d.vtp_gtmOnSuccess,e),h=f.wh,k=f.onSuccess;if(d.vtp_useIframe){}else d.vtp_supportDocumentWrite?b(h,k,e):a(D.body,ld(h),k,e)()}else Ln(function(){c(d)},
200)};V.__html=c;V.__html.h="html";V.__html.m=!0;V.__html.priorityOverride=0}();

V.g.dbg=["google"],function(){(function(a){V.__dbg=a;V.__dbg.h="dbg";V.__dbg.m=!0;V.__dbg.priorityOverride=0})(function(){return!1})}();
